...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function vg(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_d(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function yg(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_d(),fragmentShader:`
...
}`;function Mw(i,e,t){let n=new ds,r=new Qe,s=new Qe,o=new vt,a=new gl({depthPacking:Jm}),l=new vl,c={},u=t.maxTextureSize,h={[Dn]:Qt,[Qt]:Dn,[On]:On},d=new Mn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qe},radius:{value:4}},vertexShader:_w,fragmentShader:xw}),m=d.clone();m.defines.HORIZONTAL_PASS=1;let g=new Hn;g.setAttribute("position",new xn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new te(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=kh;let f=this.type;this.render=function(C,T,I){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;let b=i.getRenderTarget(),x=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),z=i.state;z.setBlending(yi),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);let k=f!==ei&&this.type===ei,j=f===ei&&this.type!==ei;for(let X=0,H=C.length;X<H;X++){let J=C[X],G=J.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);let se=G.getFrameExtents();if(r.multiply(se),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/se.x),r.x=s.x*se.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/se.y),r.y=s.y*se.y,G.mapSize.y=s.y)),G.map===null||k===!0||j===!0){let Re=this.type!==ei?{minFilter:Ln,magFilter:Ln}:{};G.map!==null&&G.map.dispose(),G.map=new Kn(r.x,r.y,Re),G.map.texture.name=J.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();let fe=G.getViewportCount();for(let Re=0;Re<fe;Re++){let Ze=G.getViewport(Re);o.set(s.x*Ze.x,s.y*Ze.y,s.x*Ze.z,s.y*Ze.w),z.viewport(o),G.updateMatrices(J,Re),n=G.getFrustum(),M(T,I,G.camera,J,this.type)}G.isPointLightShadow!==!0&&this.type===ei&&w(G,I),G.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(b,x,R)};function w(C,T){let I=e.update(y);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Kn(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(T,null,I,d,y,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(T,null,I,m,y,null)}function S(C,T,I,b){let x=null,R=I.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(R!==void 0)x=R;else if(x=I.isPointLight===!0?l:a,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0||T.alphaToCoverage===!0){let z=x.uuid,k=T.uuid,j=c[z];j===void 0&&(j={},c[z]=j);let X=j[k];X===void 0&&(X=x.clone(),j[k]=X,T.addEventListener("dispose",D)),x=X}if(x.visible=T.visible,x.wireframe=T.wireframe,b===ei?x.side=T.shadowSide!==null?T.shadowSide:T.side:x.side=T.shadowSide!==null?T.shadowSide:h[T.side],x.alphaMap=T.alphaMap,x.alphaTest=T.alphaToCoverage===!0?.5:T.alphaTest,x.map=T.map,x.clipShadows=T.clipShadows,x.clippingPlanes=T.clippingPlanes,x.clipIntersection=T.clipIntersection,x.displacementMap=T.displacementMap,x.displacementScale=T.displacementScale,x.displacementBias=T.displacementBias,x.wireframeLinewidth=T.wireframeLinewidth,x.linewidth=T.linewidth,I.isPointLight===!0&&x.isMeshDistanceMaterial===!0){let z=i.properties.get(x);z.light=I}return x}function M(C,T,I,b,x){if(C.visible===!1)return;if(C.layers.test(T.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===ei)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,C.matrixWorld);let k=e.update(C),j=C.material;if(Array.isArray(j)){let X=k.groups;for(let H=0,J=X.length;H<J;H++){let G=X[H],se=j[G.materialIndex];if(se&&se.visible){let fe=S(C,se,b,x);C.onBeforeShadow(i,C,T,I,k,fe,G),i.renderBufferDirect(I,null,k,fe,C,G),C.onAfterShadow(i,C,T,I,k,fe,G)}}}else if(j.visible){let X=S(C,j,b,x);C.onBeforeShadow(i,C,T,I,k,X,null),i.renderBufferDirect(I,null,k,X,C,null),C.onAfterShadow(i,C,T,I,k,X,null)}}let z=C.children;for(let k=0,j=z.length;k<j;k++)M(z[k],T,I,b,x)}function D(C){C.target.removeEventListener("dispose",D);for(let I in c){let b=c[I],x=C.target.uuid;x in b&&(b[x].dispose(),delete b[x])}}}var bw={[Dl]:Ll,[Ol]:Ul,[Nl]:kl,[fr]:Fl,[Ll]:Dl,[Ul]:Ol,[kl]:Nl,[Fl]:fr};function Sw(i,e){function t(){let P=!1,ue=new vt,ee=null,ge=new vt(0,0,0,0);return{setMask:function(ne){ee!==ne&&!P&&(i.colorMask(ne,ne,ne,ne),ee=ne)},setLocked:function(ne){P=ne},setClear:function(ne,Z,ye,Ge,wt){wt===!0&&(ne*=Ge,Z*=Ge,ye*=Ge),ue.set(ne,Z,ye,Ge),ge.equals(ue)===!1&&(i.clearColor(ne,Z,ye,Ge),ge.copy(ue))},reset:function(){P=!1,ee=null,ge.set(-1,0,0,0)}}}function n(){let P=!1,ue=!1,ee=null,ge=null,ne=null;return{setReversed:function(Z){if(ue!==Z){let ye=e.get("EXT_clip_control");Z?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),ue=Z;let Ge=ne;ne=null,this.setClear(Ge)}},getReversed:function(){return ue},setTest:function(Z){Z?de(i.DEPTH_TEST):Ce(i.DEPTH_TEST)},setMask:function(Z){ee!==Z&&!P&&(i.depthMask(Z),ee=Z)},setFunc:function(Z){if(ue&&(Z=bw[Z]),ge!==Z){switch(Z){case Dl:i.depthFunc(i.NEVER);break;case Ll:i.depthFunc(i.ALWAYS);break;case Ol:i.depthFunc(i.LESS);break;case fr:i.depthFunc(i.LEQUAL);break;case Nl:i.depthFunc(i.EQUAL);break;case Fl:i.depthFunc(i.GEQUAL);break;case Ul:i.depthFunc(i.GREATER);break;case kl:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ge=Z}},setLocked:function(Z){P=Z},setClear:function(Z){ne!==Z&&(ue&&(Z=1-Z),i.clearDepth(Z),ne=Z)},reset:function(){P=!1,ee=null,ge=null,ne=null,ue=!1}}}function r(){let P=!1,ue=null,ee=null,ge=null,ne=null,Z=null,ye=null,Ge=null,wt=null;return{setTest:function(mt){P||(mt?de(i.STENCIL_TEST):Ce(i.STENCIL_TEST))},setMask:function(mt){ue!==mt&&!P&&(i.stencilMask(mt),ue=mt)},setFunc:function(mt,Fn,ri){(ee!==mt||ge!==Fn||ne!==ri)&&(i.stencilFunc(mt,Fn,ri),ee=mt,ge=Fn,ne=ri)},setOp:function(mt,Fn,ri){(Z!==mt||ye!==Fn||Ge!==ri)&&(i.stencilOp(mt,Fn,ri),Z=mt,ye=Fn,Ge=ri)},setLocked:function(mt){P=mt},setClear:function(mt){wt!==mt&&(i.clearStencil(mt),wt=mt)},reset:function(){P=!1,ue=null,ee=null,ge=null,ne=null,Z=null,ye=null,Ge=null,wt=null}}}let s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap,u={},h={},d=new WeakMap,m=[],g=null,y=!1,p=null,f=null,w=null,S=null,M=null,D=null,C=null,T=new it(0,0,0),I=0,b=!1,x=null,R=null,z=null,k=null,j=null,X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),H=!1,J=0,G=i.getParameter(i.VERSION);G.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(G)[1]),H=J>=1):G.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),H=J>=2);let se=null,fe={},Re=i.getParameter(i.SCISSOR_BOX),Ze=i.getParameter(i.VIEWPORT),_t=new vt().fromArray(Re),Y=new vt().fromArray(Ze);function re(P,ue,ee,ge){let ne=new Uint8Array(4),Z=i.createTexture();i.bindTexture(P,Z),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ye=0;ye<ee;ye++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ue,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,ne):i.texImage2D(ue+ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ne);return Z}let Ee={};Ee[i.TEXTURE_2D]=re(i.TEXTURE_2D,i.TEXTURE_2D,1),Ee[i.TEXTURE_CUBE_MAP]=re(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Ee[i.TEXTURE_2D_ARRAY]=re(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Ee[i.TEXTURE_3D]=re(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),de(i.DEPTH_TEST),o.setFunc(fr),dt(!1),Mt(Uh),de(i.CULL_FACE),A(yi);function de(P){u[P]!==!0&&(i.enable(P),u[P]=!0)}function Ce(P){u[P]!==!1&&(i.disable(P),u[P]=!1)}function ut(P,ue){return h[P]!==ue?(i.bindFramebuffer(P,ue),h[P]=ue,P===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ue),P===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ue),!0):!1}function Fe(P,ue){let ee=m,ge=!1;if(P){ee=d.get(ue),ee===void 0&&(ee=[],d.set(ue,ee));let ne=P.textures;if(ee.length!==ne.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,ye=ne.length;Z<ye;Z++)ee[Z]=i.COLOR_ATTACHMENT0+Z;ee.length=ne.length,ge=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,ge=!0);ge&&i.drawBuffers(ee)}function Rt(P){return g!==P?(i.useProgram(P),g=P,!0):!1}let It={[zi]:i.FUNC_ADD,[Sm]:i.FUNC_SUBTRACT,[wm]:i.FUNC_REVERSE_SUBTRACT};It[Em]=i.MIN,It[Tm]=i.MAX;let ht={[Cm]:i.ZERO,[Am]:i.ONE,[Rm]:i.SRC_COLOR,[ol]:i.SRC_ALPHA,[Nm]:i.SRC_ALPHA_SATURATE,[Lm]:i.DST_COLOR,[Pm]:i.DST_ALPHA,[Im]:i.ONE_MINUS_SRC_COLOR,[al]:i.ONE_MINUS_SRC_ALPHA,[Om]:i.ONE_MINUS_DST_COLOR,[Dm]:i.ONE_MINUS_DST_ALPHA,[Fm]:i.CONSTANT_COLOR,[Um]:i.ONE_MINUS_CONSTANT_COLOR,[km]:i.CONSTANT_ALPHA,[Bm]:i.ONE_MINUS_CONSTANT_ALPHA};function A(P,ue,ee,ge,ne,Z,ye,Ge,wt,mt){if(P===yi){y===!0&&(Ce(i.BLEND),y=!1);return}if(y===!1&&(de(i.BLEND),y=!0),P!==bm){if(P!==p||mt!==b){if((f!==zi||M!==zi)&&(i.blendEquation(i.FUNC_ADD),f=zi,M=zi),mt)switch(P){case dr:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Bh:i.blendFunc(i.ONE,i.ONE);break;case Vh:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case zh:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case dr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Bh:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Vh:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case zh:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}w=null,S=null,D=null,C=null,T.set(0,0,0),I=0,p=P,b=mt}return}ne=ne||ue,Z=Z||ee,ye=ye||ge,(ue!==f||ne!==M)&&(i.blendEquationSeparate(It[ue],It[ne]),f=ue,M=ne),(ee!==w||ge!==S||Z!==D||ye!==C)&&(i.blendFuncSeparate(ht[ee],ht[ge],ht[Z],ht[ye]),w=ee,S=ge,D=Z,C=ye),(Ge.equals(T)===!1||wt!==I)&&(i.blendColor(Ge.r,Ge.g,Ge.b,wt),T.copy(Ge),I=wt),p=P,b=!1}function an(P,ue){P.side===On?Ce(i.CULL_FACE):de(i.CULL_FACE);let ee=P.side===Qt;ue&&(ee=!ee),dt(ee),P.blending===dr&&P.transparent===!1?A(yi):A(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),o.setFunc(P.depthFunc),o.setTest(P.depthTest),o.setMask(P.depthWrite),s.setMask(P.colorWrite);let ge=P.stencilWrite;a.setTest(ge),ge&&(a.setMask(P.stencilWriteMask),a.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),a.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),at(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?de(i.SAMPLE_ALPHA_TO_COVERAGE):Ce(i.SAMPLE_ALPHA_TO_COVERAGE)}function dt(P){x!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),x=P)}function Mt(P){P!==xm?(de(i.CULL_FACE),P!==R&&(P===Uh?i.cullFace(i.BACK):P===Mm?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ce(i.CULL_FACE),R=P}function be(P){P!==z&&(H&&i.lineWidth(P),z=P)}function at(P,ue,ee){P?(de(i.POLYGON_OFFSET_FILL),(k!==ue||j!==ee)&&(i.polygonOffset(ue,ee),k=ue,j=ee)):Ce(i.POLYGON_OFFSET_FILL)}function De(P){P?de(i.SCISSOR_TEST):Ce(i.SCISSOR_TEST)}function qe(P){P===void 0&&(P=i.TEXTURE0+X-1),se!==P&&(i.activeTexture(P),se=P)}function Vt(P,ue,ee){ee===void 0&&(se===null?ee=i.TEXTURE0+X-1:ee=se);let ge=fe[ee];ge===void 0&&(ge={type:void 0,texture:void 0},fe[ee]=ge),(ge.type!==P||ge.texture!==ue)&&(se!==ee&&(i.activeTexture(ee),se=ee),i.bindTexture(P,ue||Ee[P]),ge.type=P,ge.texture=ue)}function E(){let P=fe[se];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function v(){try{i.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function F(){try{i.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function q(){try{i.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{i.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Se(){try{i.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function le(){try{i.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Me(){try{i.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function we(){try{i.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Q(){try{i.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function pe(P){_t.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),_t.copy(P))}function Ne(P){Y.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),Y.copy(P))}function Oe(P,ue){let ee=c.get(ue);ee===void 0&&(ee=new WeakMap,c.set(ue,ee));let ge=ee.get(P);ge===void 0&&(ge=i.getUniformBlockIndex(ue,P.name),ee.set(P,ge))}function oe(P,ue){let ge=c.get(ue).get(P);l.get(ue)!==ge&&(i.uniformBlockBinding(ue,ge,P.__bindingPointIndex),l.set(ue,ge))}function He(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},se=null,fe={},h={},d=new WeakMap,m=[],g=null,y=!1,p=null,f=null,w=null,S=null,M=null,D=null,C=null,T=new it(0,0,0),I=0,b=!1,x=null,R=null,z=null,k=null,j=null,_t.set(0,0,i.canvas.width,i.canvas.height),Y.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:de,disable:Ce,bindFramebuffer:ut,drawBuffers:Fe,useProgram:Rt,setBlending:A,setMaterial:an,setFlipSided:dt,setCullFace:Mt,setLineWidth:be,setPolygonOffset:at,setScissorTest:De,activeTexture:qe,bindTexture:Vt,unbindTexture:E,compressedTexImage2D:v,compressedTexImage3D:F,texImage2D:we,texImage3D:Q,updateUBOMapping:Oe,uniformBlockBinding:oe,texStorage2D:le,texStorage3D:Me,texSubImage2D:q,texSubImage3D:K,compressedTexSubImage2D:W,compressedTexSubImage3D:Se,scissor:pe,viewport:Ne,reset:He}}function ww(i,e,t,n,r,s,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Qe,u=new WeakMap,h,d=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,v){return m?new OffscreenCanvas(E,v):as("canvas")}function y(E,v,F){let q=1,K=Vt(E);if((K.width>F||K.height>F)&&(q=F/Math.max(K.width,K.height)),q<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){let W=Math.floor(q*K.width),Se=Math.floor(q*K.height);h===void 0&&(h=g(W,Se));let le=v?g(W,Se):h;return le.width=W,le.height=Se,le.getContext("2d").drawImage(E,0,0,W,Se),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+W+"x"+Se+")."),le}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),E;return E}function p(E){return E.generateMipmaps}function f(E){i.generateMipmap(E)}function w(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(E,v,F,q,K=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let W=v;if(v===i.RED&&(F===i.FLOAT&&(W=i.R32F),F===i.HALF_FLOAT&&(W=i.R16F),F===i.UNSIGNED_BYTE&&(W=i.R8)),v===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.R8UI),F===i.UNSIGNED_SHORT&&(W=i.R16UI),F===i.UNSIGNED_INT&&(W=i.R32UI),F===i.BYTE&&(W=i.R8I),F===i.SHORT&&(W=i.R16I),F===i.INT&&(W=i.R32I)),v===i.RG&&(F===i.FLOAT&&(W=i.RG32F),F===i.HALF_FLOAT&&(W=i.RG16F),F===i.UNSIGNED_BYTE&&(W=i.RG8)),v===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.RG8UI),F===i.UNSIGNED_SHORT&&(W=i.RG16UI),F===i.UNSIGNED_INT&&(W=i.RG32UI),F===i.BYTE&&(W=i.RG8I),F===i.SHORT&&(W=i.RG16I),F===i.INT&&(W=i.RG32I)),v===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.RGB8UI),F===i.UNSIGNED_SHORT&&(W=i.RGB16UI),F===i.UNSIGNED_INT&&(W=i.RGB32UI),F===i.BYTE&&(W=i.RGB8I),F===i.SHORT&&(W=i.RGB16I),F===i.INT&&(W=i.RGB32I)),v===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(W=i.RGBA16UI),F===i.UNSIGNED_INT&&(W=i.RGBA32UI),F===i.BYTE&&(W=i.RGBA8I),F===i.SHORT&&(W=i.RGBA16I),F===i.INT&&(W=i.RGBA32I)),v===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(W=i.RGB9_E5),v===i.RGBA){let Se=K?mo:ot.getTransfer(q);F===i.FLOAT&&(W=i.RGBA32F),F===i.HALF_FLOAT&&(W=i.RGBA16F),F===i.UNSIGNED_BYTE&&(W=Se===yt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(W=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(W=i.RGB5_A1)}return(W===i.R16F||W===i.R32F||W===i.RG16F||W===i.RG32F||W===i.RGBA16F||W===i.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function M(E,v){let F;return E?v===null||v===$i||v===vs?F=i.DEPTH24_STENCIL8:v===ti?F=i.DEPTH32F_STENCIL8:v===ms&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===$i||v===vs?F=i.DEPTH_COMPONENT24:v===ti?F=i.DEPTH_COMPONENT32F:v===ms&&(F=i.DEPTH_COMPONENT16),F}function D(E,v){return p(E)===!0||E.isFramebufferTexture&&E.minFilter!==Ln&&E.minFilter!==zn?Math.log2(Math.max(v.width,v.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?v.mipmaps.length:1}function C(E){let v=E.target;v.removeEventListener("dispose",C),I(v),v.isVideoTexture&&u.delete(v)}function T(E){let v=E.target;v.removeEventListener("dispose",T),x(v)}function I(E){let v=n.get(E);if(v.__webglInit===void 0)return;let F=E.source,q=d.get(F);if(q){let K=q[v.__cacheKey];K.usedTimes--,K.usedTimes===0&&b(E),Object.keys(q).length===0&&d.delete(F)}n.remove(E)}function b(E){let v=n.get(E);i.deleteTexture(v.__webglTexture);let F=E.source,q=d.get(F);delete q[v.__cacheKey],o.memory.textures--}function x(E){let v=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(v.__webglFramebuffer[q]))for(let K=0;K<v.__webglFramebuffer[q].length;K++)i.deleteFramebuffer(v.__webglFramebuffer[q][K]);else i.deleteFramebuffer(v.__webglFramebuffer[q]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[q])}else{if(Array.isArray(v.__webglFramebuffer))for(let q=0;q<v.__webglFramebuffer.length;q++)i.deleteFramebuffer(v.__webglFramebuffer[q]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let q=0;q<v.__webglColorRenderbuffer.length;q++)v.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[q]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let F=E.textures;for(let q=0,K=F.length;q<K;q++){let W=n.get(F[q]);W.__webglTexture&&(i.deleteTexture(W.__webglTexture),o.memory.textures--),n.remove(F[q])}n.remove(E)}let R=0;function z(){R=0}function k(){let E=R;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),R+=1,E}function j(E){let v=[];return v.push(E.wrapS),v.push(E.wrapT),v.push(E.wrapR||0),v.push(E.magFilter),v.push(E.minFilter),v.push(E.anisotropy),v.push(E.internalFormat),v.push(E.format),v.push(E.type),v.push(E.generateMipmaps),v.push(E.premultiplyAlpha),v.push(E.flipY),v.push(E.unpackAlignment),v.push(E.colorSpace),v.join()}function X(E,v){let F=n.get(E);if(E.isVideoTexture&&De(E),E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){let q=E.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(F,E,v);return}}t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+v)}function H(E,v){let F=n.get(E);if(E.version>0&&F.__version!==E.version){Ee(F,E,v);return}t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+v)}function J(E,v){let F=n.get(E);if(E.version>0&&F.__version!==E.version){Ee(F,E,v);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+v)}function G(E,v){let F=n.get(E);if(E.version>0&&F.__version!==E.version){de(F,E,v);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+v)}let se={[ll]:i.REPEAT,[Vi]:i.CLAMP_TO_EDGE,[cl]:i.MIRRORED_REPEAT},fe={[Ln]:i.NEAREST,[Ym]:i.NEAREST_MIPMAP_NEAREST,[Bo]:i.NEAREST_MIPMAP_LINEAR,[zn]:i.LINEAR,[zl]:i.LINEAR_MIPMAP_NEAREST,[qi]:i.LINEAR_MIPMAP_LINEAR},Re={[Qm]:i.NEVER,[sg]:i.ALWAYS,[eg]:i.LESS,[Kh]:i.LEQUAL,[tg]:i.EQUAL,[rg]:i.GEQUAL,[ng]:i.GREATER,[ig]:i.NOTEQUAL};function Ze(E,v){if(v.type===ti&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===zn||v.magFilter===zl||v.magFilter===Bo||v.magFilter===qi||v.minFilter===zn||v.minFilter===zl||v.minFilter===Bo||v.minFilter===qi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,se[v.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,se[v.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,se[v.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,fe[v.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,fe[v.minFilter]),v.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,Re[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ln||v.minFilter!==Bo&&v.minFilter!==qi||v.type===ti&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){let F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function _t(E,v){let F=!1;E.__webglInit===void 0&&(E.__webglInit=!0,v.addEventListener("dispose",C));let q=v.source,K=d.get(q);K===void 0&&(K={},d.set(q,K));let W=j(v);if(W!==E.__cacheKey){K[W]===void 0&&(K[W]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),K[W].usedTimes++;let Se=K[E.__cacheKey];Se!==void 0&&(K[E.__cacheKey].usedTimes--,Se.usedTimes===0&&b(v)),E.__cacheKey=W,E.__webglTexture=K[W].texture}return F}function Y(E,v,F){return Math.floor(Math.floor(E/F)/v)}function re(E,v,F,q){let W=E.updateRanges;if(W.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,v.width,v.height,F,q,v.data);else{W.sort((Q,pe)=>Q.start-pe.start);let Se=0;for(let Q=1;Q<W.length;Q++){let pe=W[Se],Ne=W[Q],Oe=pe.start+pe.count,oe=Y(Ne.start,v.width,4),He=Y(pe.start,v.width,4);Ne.start<=Oe+1&&oe===He&&Y(Ne.start+Ne.count-1,v.width,4)===oe?pe.count=Math.max(pe.count,Ne.start+Ne.count-pe.start):(++Se,W[Se]=Ne)}W.length=Se+1;let le=i.getParameter(i.UNPACK_ROW_LENGTH),Me=i.getParameter(i.UNPACK_SKIP_PIXELS),we=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,v.width);for(let Q=0,pe=W.length;Q<pe;Q++){let Ne=W[Q],Oe=Math.floor(Ne.start/4),oe=Math.ceil(Ne.count/4),He=Oe%v.width,P=Math.floor(Oe/v.width),ue=oe,ee=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,He),i.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,He,P,ue,ee,F,q,v.data)}E.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,le),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Me),i.pixelStorei(i.UNPACK_SKIP_ROWS,we)}}function Ee(E,v,F){let q=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(q=i.TEXTURE_3D);let K=_t(E,v),W=v.source;t.bindTexture(q,E.__webglTexture,i.TEXTURE0+F);let Se=n.get(W);if(W.version!==Se.__version||K===!0){t.activeTexture(i.TEXTURE0+F);let le=ot.getPrimaries(ot.workingColorSpace),Me=v.colorSpace===xi?null:ot.getPrimaries(v.colorSpace),we=v.colorSpace===xi||le===Me?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);let Q=y(v.image,!1,r.maxTextureSize);Q=qe(v,Q);let pe=s.convert(v.format,v.colorSpace),Ne=s.convert(v.type),Oe=S(v.internalFormat,pe,Ne,v.colorSpace,v.isVideoTexture);Ze(q,v);let oe,He=v.mipmaps,P=v.isVideoTexture!==!0,ue=Se.__version===void 0||K===!0,ee=W.dataReady,ge=D(v,Q);if(v.isDepthTexture)Oe=M(v.format===ys,v.type),ue&&(P?t.texStorage2D(i.TEXTURE_2D,1,Oe,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,Oe,Q.width,Q.height,0,pe,Ne,null));else if(v.isDataTexture)if(He.length>0){P&&ue&&t.texStorage2D(i.TEXTURE_2D,ge,Oe,He[0].width,He[0].height);for(let ne=0,Z=He.length;ne<Z;ne++)oe=He[ne],P?ee&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,oe.width,oe.height,pe,Ne,oe.data):t.texImage2D(i.TEXTURE_2D,ne,Oe,oe.width,oe.height,0,pe,Ne,oe.data);v.generateMipmaps=!1}else P?(ue&&t.texStorage2D(i.TEXTURE_2D,ge,Oe,Q.width,Q.height),ee&&re(v,Q,pe,Ne)):t.texImage2D(i.TEXTURE_2D,0,Oe,Q.width,Q.height,0,pe,Ne,Q.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){P&&ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,Oe,He[0].width,He[0].height,Q.depth);for(let ne=0,Z=He.length;ne<Z;ne++)if(oe=He[ne],v.format!==Nn)if(pe!==null)if(P){if(ee)if(v.layerUpdates.size>0){let ye=rd(oe.width,oe.height,v.format,v.type);for(let Ge of v.layerUpdates){let wt=oe.data.subarray(Ge*ye/oe.data.BYTES_PER_ELEMENT,(Ge+1)*ye/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,Ge,oe.width,oe.height,1,pe,wt)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,oe.width,oe.height,Q.depth,pe,oe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ne,Oe,oe.width,oe.height,Q.depth,0,oe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?ee&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,oe.width,oe.height,Q.depth,pe,Ne,oe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ne,Oe,oe.width,oe.height,Q.depth,0,pe,Ne,oe.data)}else{P&&ue&&t.texStorage2D(i.TEXTURE_2D,ge,Oe,He[0].width,He[0].height);for(let ne=0,Z=He.length;ne<Z;ne++)oe=He[ne],v.format!==Nn?pe!==null?P?ee&&t.compressedTexSubImage2D(i.TEXTURE_2D,ne,0,0,oe.width,oe.height,pe,oe.data):t.compressedTexImage2D(i.TEXTURE_2D,ne,Oe,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?ee&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,oe.width,oe.height,pe,Ne,oe.data):t.texImage2D(i.TEXTURE_2D,ne,Oe,oe.width,oe.height,0,pe,Ne,oe.data)}else if(v.isDataArrayTexture)if(P){if(ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,Oe,Q.width,Q.height,Q.depth),ee)if(v.layerUpdates.size>0){let ne=rd(Q.width,Q.height,v.format,v.type);for(let Z of v.layerUpdates){let ye=Q.data.subarray(Z*ne/Q.data.BYTES_PER_ELEMENT,(Z+1)*ne/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,Q.width,Q.height,1,pe,Ne,ye)}v.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,pe,Ne,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Oe,Q.width,Q.height,Q.depth,0,pe,Ne,Q.data);else if(v.isData3DTexture)P?(ue&&t.texStorage3D(i.TEXTURE_3D,ge,Oe,Q.width,Q.height,Q.depth),ee&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,pe,Ne,Q.data)):t.texImage3D(i.TEXTURE_3D,0,Oe,Q.width,Q.height,Q.depth,0,pe,Ne,Q.data);else if(v.isFramebufferTexture){if(ue)if(P)t.texStorage2D(i.TEXTURE_2D,ge,Oe,Q.width,Q.height);else{let ne=Q.width,Z=Q.height;for(let ye=0;ye<ge;ye++)t.texImage2D(i.TEXTURE_2D,ye,Oe,ne,Z,0,pe,Ne,null),ne>>=1,Z>>=1}}else if(He.length>0){if(P&&ue){let ne=Vt(He[0]);t.texStorage2D(i.TEXTURE_2D,ge,Oe,ne.width,ne.height)}for(let ne=0,Z=He.length;ne<Z;ne++)oe=He[ne],P?ee&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,pe,Ne,oe):t.texImage2D(i.TEXTURE_2D,ne,Oe,pe,Ne,oe);v.generateMipmaps=!1}else if(P){if(ue){let ne=Vt(Q);t.texStorage2D(i.TEXTURE_2D,ge,Oe,ne.width,ne.height)}ee&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,Ne,Q)}else t.texImage2D(i.TEXTURE_2D,0,Oe,pe,Ne,Q);p(v)&&f(q),Se.__version=W.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function de(E,v,F){if(v.image.length!==6)return;let q=_t(E,v),K=v.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+F);let W=n.get(K);if(K.version!==W.__version||q===!0){t.activeTexture(i.TEXTURE0+F);let Se=ot.getPrimaries(ot.workingColorSpace),le=v.colorSpace===xi?null:ot.getPrimaries(v.colorSpace),Me=v.colorSpace===xi||Se===le?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me);let we=v.isCompressedTexture||v.image[0].isCompressedTexture,Q=v.image[0]&&v.image[0].isDataTexture,pe=[];for(let Z=0;Z<6;Z++)!we&&!Q?pe[Z]=y(v.image[Z],!0,r.maxCubemapSize):pe[Z]=Q?v.image[Z].image:v.image[Z],pe[Z]=qe(v,pe[Z]);let Ne=pe[0],Oe=s.convert(v.format,v.colorSpace),oe=s.convert(v.type),He=S(v.internalFormat,Oe,oe,v.colorSpace),P=v.isVideoTexture!==!0,ue=W.__version===void 0||q===!0,ee=K.dataReady,ge=D(v,Ne);Ze(i.TEXTURE_CUBE_MAP,v);let ne;if(we){P&&ue&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,He,Ne.width,Ne.height);for(let Z=0;Z<6;Z++){ne=pe[Z].mipmaps;for(let ye=0;ye<ne.length;ye++){let Ge=ne[ye];v.format!==Nn?Oe!==null?P?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,0,0,Ge.width,Ge.height,Oe,Ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,He,Ge.width,Ge.height,0,Ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,0,0,Ge.width,Ge.height,Oe,oe,Ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,He,Ge.width,Ge.height,0,Oe,oe,Ge.data)}}}else{if(ne=v.mipmaps,P&&ue){ne.length>0&&ge++;let Z=Vt(pe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,He,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(Q){P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,pe[Z].width,pe[Z].height,Oe,oe,pe[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,He,pe[Z].width,pe[Z].height,0,Oe,oe,pe[Z].data);for(let ye=0;ye<ne.length;ye++){let wt=ne[ye].image[Z].image;P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,0,0,wt.width,wt.height,Oe,oe,wt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,He,wt.width,wt.height,0,Oe,oe,wt.data)}}else{P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Oe,oe,pe[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,He,Oe,oe,pe[Z]);for(let ye=0;ye<ne.length;ye++){let Ge=ne[ye];P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,0,0,Oe,oe,Ge.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,He,Oe,oe,Ge.image[Z])}}}p(v)&&f(i.TEXTURE_CUBE_MAP),W.__version=K.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function Ce(E,v,F,q,K,W){let Se=s.convert(F.format,F.colorSpace),le=s.convert(F.type),Me=S(F.internalFormat,Se,le,F.colorSpace),we=n.get(v),Q=n.get(F);if(Q.__renderTarget=v,!we.__hasExternalTextures){let pe=Math.max(1,v.width>>W),Ne=Math.max(1,v.height>>W);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,W,Me,pe,Ne,v.depth,0,Se,le,null):t.texImage2D(K,W,Me,pe,Ne,0,Se,le,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),at(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,K,Q.__webglTexture,0,be(v)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,K,Q.__webglTexture,W),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ut(E,v,F){if(i.bindRenderbuffer(i.RENDERBUFFER,E),v.depthBuffer){let q=v.depthTexture,K=q&&q.isDepthTexture?q.type:null,W=M(v.stencilBuffer,K),Se=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,le=be(v);at(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,le,W,v.width,v.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,le,W,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,W,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Se,i.RENDERBUFFER,E)}else{let q=v.textures;for(let K=0;K<q.length;K++){let W=q[K],Se=s.convert(W.format,W.colorSpace),le=s.convert(W.type),Me=S(W.internalFormat,Se,le,W.colorSpace),we=be(v);F&&at(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,we,Me,v.width,v.height):at(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,we,Me,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,Me,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Fe(E,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let q=n.get(v.depthTexture);q.__renderTarget=v,(!q.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),X(v.depthTexture,0);let K=q.__webglTexture,W=be(v);if(v.depthTexture.format===os)at(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0,W):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0);else if(v.depthTexture.format===ys)at(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0,W):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function Rt(E){let v=n.get(E),F=E.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==E.depthTexture){let q=E.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),q){let K=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,q.removeEventListener("dispose",K)};q.addEventListener("dispose",K),v.__depthDisposeCallback=K}v.__boundDepthTexture=q}if(E.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");let q=E.texture.mipmaps;q&&q.length>0?Fe(v.__webglFramebuffer[0],E):Fe(v.__webglFramebuffer,E)}else if(F){v.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[q]),v.__webglDepthbuffer[q]===void 0)v.__webglDepthbuffer[q]=i.createRenderbuffer(),ut(v.__webglDepthbuffer[q],E,!1);else{let K=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,W),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,W)}}else{let q=E.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),ut(v.__webglDepthbuffer,E,!1);else{let K=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,W),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,W)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function It(E,v,F){let q=n.get(E);v!==void 0&&Ce(q.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Rt(E)}function ht(E){let v=E.texture,F=n.get(E),q=n.get(v);E.addEventListener("dispose",T);let K=E.textures,W=E.isWebGLCubeRenderTarget===!0,Se=K.length>1;if(Se||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=v.version,o.memory.textures++),W){F.__webglFramebuffer=[];for(let le=0;le<6;le++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[le]=[];for(let Me=0;Me<v.mipmaps.length;Me++)F.__webglFramebuffer[le][Me]=i.createFramebuffer()}else F.__webglFramebuffer[le]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let le=0;le<v.mipmaps.length;le++)F.__webglFramebuffer[le]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(Se)for(let le=0,Me=K.length;le<Me;le++){let we=n.get(K[le]);we.__webglTexture===void 0&&(we.__webglTexture=i.createTexture(),o.memory.textures++)}if(E.samples>0&&at(E)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let le=0;le<K.length;le++){let Me=K[le];F.__webglColorRenderbuffer[le]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[le]);let we=s.convert(Me.format,Me.colorSpace),Q=s.convert(Me.type),pe=S(Me.internalFormat,we,Q,Me.colorSpace,E.isXRRenderTarget===!0),Ne=be(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ne,pe,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,F.__webglColorRenderbuffer[le])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),ut(F.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(W){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Ze(i.TEXTURE_CUBE_MAP,v);for(let le=0;le<6;le++)if(v.mipmaps&&v.mipmaps.length>0)for(let Me=0;Me<v.mipmaps.length;Me++)Ce(F.__webglFramebuffer[le][Me],E,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+le,Me);else Ce(F.__webglFramebuffer[le],E,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);p(v)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let le=0,Me=K.length;le<Me;le++){let we=K[le],Q=n.get(we);t.bindTexture(i.TEXTURE_2D,Q.__webglTexture),Ze(i.TEXTURE_2D,we),Ce(F.__webglFramebuffer,E,we,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,0),p(we)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let le=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(le=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(le,q.__webglTexture),Ze(le,v),v.mipmaps&&v.mipmaps.length>0)for(let Me=0;Me<v.mipmaps.length;Me++)Ce(F.__webglFramebuffer[Me],E,v,i.COLOR_ATTACHMENT0,le,Me);else Ce(F.__webglFramebuffer,E,v,i.COLOR_ATTACHMENT0,le,0);p(v)&&f(le),t.unbindTexture()}E.depthBuffer&&Rt(E)}function A(E){let v=E.textures;for(let F=0,q=v.length;F<q;F++){let K=v[F];if(p(K)){let W=w(E),Se=n.get(K).__webglTexture;t.bindTexture(W,Se),f(W),t.unbindTexture()}}}let an=[],dt=[];function Mt(E){if(E.samples>0){if(at(E)===!1){let v=E.textures,F=E.width,q=E.height,K=i.COLOR_BUFFER_BIT,W=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Se=n.get(E),le=v.length>1;if(le)for(let we=0;we<v.length;we++)t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer);let Me=E.texture.mipmaps;Me&&Me.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let we=0;we<v.length;we++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),le){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Se.__webglColorRenderbuffer[we]);let Q=n.get(v[we]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Q,0)}i.blitFramebuffer(0,0,F,q,0,0,F,q,K,i.NEAREST),l===!0&&(an.length=0,dt.length=0,an.push(i.COLOR_ATTACHMENT0+we),E.depthBuffer&&E.resolveDepthBuffer===!1&&(an.push(W),dt.push(W),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,dt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,an))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),le)for(let we=0;we<v.length;we++){t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,Se.__webglColorRenderbuffer[we]);let Q=n.get(v[we]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,Q,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){let v=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function be(E){return Math.min(r.maxSamples,E.samples)}function at(E){let v=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function De(E){let v=o.render.frame;u.get(E)!==v&&(u.set(E,v),E.update())}function qe(E,v){let F=E.colorSpace,q=E.format,K=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||F!==pr&&F!==xi&&(ot.getTransfer(F)===yt?(q!==Nn||K!==Wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function Vt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=z,this.setTexture2D=X,this.setTexture2DArray=H,this.setTexture3D=J,this.setTextureCube=G,this.rebindTextures=It,this.setupRenderTarget=ht,this.updateRenderTargetMipmap=A,this.updateMultisampleRenderTarget=Mt,this.setupDepthRenderbuffer=Rt,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=at}function Ew(i,e){function t(n,r=xi){let s,o=ot.getTransfer(r);if(n===Wn)return i.UNSIGNED_BYTE;if(n===Gl)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Wl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Xh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Gh)return i.BYTE;if(n===Wh)return i.SHORT;if(n===ms)return i.UNSIGNED_SHORT;if(n===Hl)return i.INT;if(n===$i)return i.UNSIGNED_INT;if(n===ti)return i.FLOAT;if(n===gs)return i.HALF_FLOAT;if(n===jh)return i.ALPHA;if(n===qh)return i.RGB;if(n===Nn)return i.RGBA;if(n===os)return i.DEPTH_COMPONENT;if(n===ys)return i.DEPTH_STENCIL;if(n===$h)return i.RED;if(n===Xl)return i.RED_INTEGER;if(n===Yh)return i.RG;if(n===jl)return i.RG_INTEGER;if(n===ql)return i.RGBA_INTEGER;if(n===Vo||n===zo||n===Ho||n===Go)if(o===yt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Vo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===zo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ho)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Go)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Vo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===zo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ho)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Go)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===$l||n===Yl||n===Zl||n===Jl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===$l)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Yl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Zl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Jl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Kl||n===Ql||n===ec)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Kl||n===Ql)return o===yt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ec)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===tc||n===nc||n===ic||n===rc||n===sc||n===oc||n===ac||n===lc||n===cc||n===uc||n===hc||n===dc||n===fc||n===pc)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===tc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===nc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ic)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===rc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===sc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===oc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ac)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===lc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===cc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===uc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===hc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===dc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===fc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===pc)return o===yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Wo||n===mc||n===gc)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Wo)return o===yt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===mc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===gc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Zh||n===vc||n===yc||n===_c)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Wo)return s.COMPRESSED_RED_RGTC1_EXT;if(n===vc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===yc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===_c)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===vs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var Tw=`
void main() {
